                    ...
                    <div className="nc-SingleHeader ">
                     <div className="space-y-5 dark text-neutral-100">
                      <div className="nc-CategoryBadgeList flex flex-wrap space-x-2" data-nc-id="CategoryBadgeList">
                       <a className="transition-colors hover:text-white duration-300 nc-Badge  inline-flex px-2.5 py-1 rounded-full font-medium text-xs !px-3 text-yellow-800 bg-yellow-100 hover:bg-yellow-800" href="/archive/the-demo-archive-slug">Industrial</a>
                      </div>
                      <h1 className=" text-neutral-900 font-semibold text-3xl md:!leading-[120%] dark:text-neutral-100 max-w-4xl " title="Julio Urías does it all as Dodgers sweep in San Francisco">Julio Urías does it all as Dodgers sweep in San Francisco</h1>
