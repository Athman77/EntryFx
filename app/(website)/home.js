      ...
      <div className="site-wrap">
        <main className="main">
            ...
            <div className="container">
              <div className="hero-content-wrap">
                <h1 className="intro-title text-center">
                  Hey, We're <span>Sucharu</span>, Explore our Thoughts,
                  Stories, Ideas.
                </h1>
                <div className="intro-description text-center">
                  This Ghost theme is perfect for{" "}
                  <strong>
                    magazine, newsletter, professional and personal blog
                  </strong>{" "}
                  publishing. Crafted readers in mind.{" "}
                  <strong>Customizable features</strong> tailored to your
                  creative vision.
                </div>
                <div
                  className="hero-search flex justify-space-between"
                  data-ghost-search=""
                >
          ...
          <div className="pagination-wrap text-center" id="pagination-wrap">
            <button className="btn post-load-button" id="load-more">
              <span>Load more</span>
            </button>
          </div>
        </main>
