            ...
            <div className="nav_extra-wrap">
              <ul className="nav-extra">
                <li className="extra-item">
                  <a href="https://vozzy.tmrwstudio.net/subscribe" className="btn-trigger button btn-text" aria-label="Subscribe">
                ...
                <li className="extra-item">
                  <a className="btn-trigger button btn-text" href="https://vozzy.tmrwstudio.net/signup" aria-label="Sign Up">
                    <span className="icon-svg">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                ...
                <li className="extra-item mobile-trigger">
                  <a href="#" className="btn-trigger menu-trigger button btn-text" aria-label="Menu">
                    <span className="icon-svg">
            ...
            <div className="logo-wrap">
              <div className="site-logo">
                <a href="https://vozzy.tmrwstudio.net" aria-label="Vozzy">
                  <img src="images/vozzy.svg" alt="Vozzy" fetchpriority="high" className="light-logo" width="100" height="50" />

                  <img src="images/vozzy-1.svg" alt="Vozzy" fetchpriority="high" className="dark-logo" width="100" height="50" />
                </a>
              </div>
            </div>
            <div className="nav_extra-wrap">
              <ul className="nav-extra">
                <li className="extra-item">
                  ...
                  <a href="#" className="btn-trigger skin-trigger trigger-light button btn-text">
                    <span className="icon-svg">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                        <path d="M37.06 32c0-8.608 5.01-16.436 12.764-19.941l4.013-1.814-4.007-1.828a25.017 25.017 0 0 0-10.46-2.263h-4C21.271 6.154 9.8 17.749 9.8 32s11.471 25.846 25.57 25.846h4c3.65 0 7.169-.761 10.46-2.263l4.007-1.827-4.013-1.814C42.07 48.436 37.06 40.608 37.06 32zm-23.232-1.123zM39.37 53.846c-11.894 0-21.57-9.8-21.57-21.846s9.676-21.846 21.57-21.846c1.631 0 3.23.181 4.786.538C37.298 15.452 33.06 23.398 33.06 32s4.239 16.548 11.097 21.308a21.367 21.367 0 0 1-4.787.538z"></path>
                      </svg>
                ...
                <li className="extra-item mob_desk-trigger">
                  <span className="btn-trigger button btn-text" data-ghost-search="">
                    <span className="icon-svg">
                ...
                <nav className="nav-main">
                  <ul className="nav">
                    ...
                    <li className="nav-membership">
                      <a href="https://vozzy.tmrwstudio.net/membership/">Membership</a>
                    </li>
                    <li className="nav-tags">
                      <a href="https://vozzy.tmrwstudio.net/tags/">Tags</a>
                    </li>
                    <li className="nav-authors">
                      <a href="https://vozzy.tmrwstudio.net/authors/">Authors</a>
                    </li>
                    <li className="nav-web-picks">
                      <a href="https://vozzy.tmrwstudio.net/web-picks/">Web Picks</a>
                    </li>
                    <li className="nav-style-guide">
                      <a href="https://vozzy.tmrwstudio.net/style-guide/">Style Guide</a>
                    </li>
                    <li className="nav-contact">
                      <a href="https://vozzy.tmrwstudio.net/contact/">Contact</a>
                    </li>
                    <li className="nav-featured">
                      <a href="https://vozzy.tmrwstudio.net/featured/">Featured</a>
                    </li>
                    <li className="nav-inbuilt-comment">
                      <a href="https://vozzy.tmrwstudio.net/love-for-all-hatred-for-none/#comments">Inbuilt Comment</a>
                    </li>
                    <li className="nav-disqus-comment">
                      <a href="https://vozzy.tmrwstudio.net/good-friends-are-like-stars/#comments">Disqus Comment</a>
                    </li>
                    <li className="nav-post-one">
                      <a href="https://vozzy.tmrwstudio.net/time-tide-wait-for-no-man/">Post One</a>
                    </li>
                    <li className="nav-post-one-sidebar">
                      <a href="https://vozzy.tmrwstudio.net/good-things-come-in-good-time/">Post One + Sidebar</a>
                    </li>
                    <li className="nav-post-two">
                      <a href="https://vozzy.tmrwstudio.net/you-are-your-best-thing/">Post Two</a>
                    </li>
                    <li className="nav-post-two-sidebar">
                      <a href="https://vozzy.tmrwstudio.net/no-guts-no-story/">Post Two + Sidebar</a>
                    </li>
                    <li className="nav-post-three">
                      <a href="https://vozzy.tmrwstudio.net/a-dream-is-only-a-dream/">Post Three</a>
                    </li>
                    <li className="nav-post-three-sidebar">
                      <a href="https://vozzy.tmrwstudio.net/time-was-gods-first-creation/">Post Three + Sidebar</a>
                    </li>
                    <li className="nav-post-rtl">
                      <a href="https://vozzy.tmrwstudio.net/all-humor-is-rooted-in-pain/">Post RTL</a>
                    </li>
                    <li className="nav-sign-up">
                      <a href="https://vozzy.tmrwstudio.net/signup/">Sign Up</a>
                    </li>
                    <li className="nav-sign-in">
                      <a href="https://vozzy.tmrwstudio.net/signin/">Sign In</a>
                    </li>
                    <li className="nav-error-404">
                      <a href="https://vozzy.tmrwstudio.net/404/">Error 404</a>
                    </li>
