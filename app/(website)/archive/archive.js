    ...
    <div className="nc-PageSearchV2">
      <div className="w-full px-2 xl:max-w-screen-2xl mx-auto">
          <div className="relative aspect-w-16 aspect-h-13 sm:aspect-h-9 lg:aspect-h-8 xl:aspect-h-5 rounded-3xl md:rounded-[40px] overflow-hidden z-0">
           <img src="https://images.pexels.com/photos/2662116/pexels-photo-2662116.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" sizes="(max-width: 1280px) 100vw, 1536px" class="object-cover w-full h-full rounded-3xl md:rounded-[40px] object-cover absolute inset-0 w-full h-full" alt="archive" />
           <div class="absolute inset-0 bg-black text-white bg-opacity-30 flex flex-col items-center justify-center">
            ...
            <span class="block mt-4 text-neutral-300"> {posts && posts?.length} Articles</span>
           </div>
          </div>
         </div>
