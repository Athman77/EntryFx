...
*[_type == "post"] | order(publishedAt asc, _createdAt desc) {
  _id,
  _createdAt,
  publishedAt,
  mainImage {
...
*[_type == "post"] | order(publishedAt asc, _createdAt desc) [0..$limit] {
  ...,
  author->,
  categories[]->
}
...
*[_type == "post"] | order(publishedAt asc, _createdAt desc) [$pageIndex...$limit] {
  ...,
  author->,
  categories[]->
}
