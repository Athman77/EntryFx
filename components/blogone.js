        ...
        <div className="box-wrap box-post space-more">
          <div className="post-list wide-thumb post-vertical-center">
            <div className="post-list-thumbnail">
              <div className="entry-thumbnail">
                ...
                <div className="thumb-info info-center"></div>
              </div>
            </div>
            ...
            <div className="post-list-desc">
              <div className="post-desc-inner">
                <div className="entry-meta meta-top">
                  <a
                    href="https://vozzy.tmrwstudio.net/featured/"
                    className="meta-featured meta-item"
                    aria-label="Featured"
                  >
                ...
                <div className="entry-excerpt">
                  I don’t want to leave this planet until I achieve everything
                ...
                <div className="entry-meta meta-bottom">
                  <div className="meta-author meta-item">
                    ...
                    <span className="info-text">
                      By�&nbsp;<a href="/author/eileen/">Eileen Dover</a>
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="read-more-icon">
            <a
              href="/what-we-think-we-become/"
              title="What We Think, We Become"
              className="post-more-icon button btn-content_icon btn-white"
            >
              <span className="icon-svg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
