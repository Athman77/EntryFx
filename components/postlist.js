    ...
    <>
      <div className="nc-Card10V2 relative flex flex-col h-full">
          ...
          <div>
            <div className="nc-PostFeaturedMedia relative w-full h-full">
              ...
              <span className="absolute inset-0 flex items-center justify-center ">
                <div
                  className="nc-PostTypeFeaturedIcon hover:scale-105 transform cursor-pointer transition-transform"
        ...
        <div className="absolute top-3 inset-x-3 flex justify-between items-start space-x-4">
          ...
          >
            <Link href={`/post/${post.slug.current}`}>
              <a className="transition-colors hover:text-white duration-300 nc-Badge  inline-flex px-2.5 py-1 rounded-full font-medium text-xs relative text-yellow-800 bg-yellow-100 hover:bg-yellow-800">
                Industrial
              </a>
            </Link>
          </div>
          ...
          <div className="nc-PostCardMetaV2 inline-flex items-center flex-wrap text-neutral-800 dark:text-neutral-200 leading-none text-xs">
            <div className="relative flex items-center space-x-2">
              ...
              <div>
                ...
                <a className="flex mt-1.5" href="/author/the-demo-author-slug">
