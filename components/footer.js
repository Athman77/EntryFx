            ...
            <div className="col">
              ...
              <div className="social-links">
                ...
                <ul>
                  <li>
                    <a
                      href="https://twitter.com/gbjsolution"
                      title="Twitter"
                      rel="noopener"
                    >
                      <svg
                  ...
                  <li>
                    <a href="#" title="Dribbble" rel="noopener">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  <li>
                    <a href="#" title="Instagram" rel="noopener">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  <li>
                    <a href="#" title="medium" rel="noopener">
                      <svg
                        width="24"
                        height="24"
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <nav className="secondary-nav-wrap">
                <ul className="secondary-nav-list">
                  <li className="features nav-item">
                    <a href="https://advant.gbjsolution.com/features/">
                      Features
                    </a>
                  </li>
                  <li className="privacy-policy nav-item">
                    <a href="https://advant.gbjsolution.com/privacy/">
                      Privacy Policy
                    </a>
                  </li>
                  <li className="contact nav-item">
                    <a href="https://advant.gbjsolution.com/contact/">
                      Contact
                    </a>
                  </li>
                </ul>
              ...
              <div className="copyright">
                © 2024 <a href="https://advant.gbjsolution.com">Advant</a> -
